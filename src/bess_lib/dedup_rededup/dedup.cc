...
// This function inserts the packet payload to the target idx
// (Note: the code will override the previous payload).
// |pkt_ptr| is the payload's pointer.
...
// This function inserts the 16 fingerprints into the fingerprint_store.
...
// |org| is the new string. |org_pos| is the hash pos in the new string.
// |target| is the matched string in payload store.
// |t_len| is the length of the string in payload store.
// |t_pos| is the hash pos in the matched string in payload store.
